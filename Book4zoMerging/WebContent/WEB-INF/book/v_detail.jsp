    	   ...
    	   $.ajax({
				...
				success:function(data){
					...
					$.each(data, function(index, item){
                        ...
                        replyList += '<div class="Comments"><ul class="CommentList"><li class="CommentItem"><div class="CommentItem_Content"><p>대댓글 내용</p></div><div class="CommentItem_Metadata"><span class="CommentItem_MaskedUId"><span class="a11y">작성자</span>'+'대댓 작성자'+'</span><span class="CommentItem_CommentDate"><span class="a11y">작성일</span>'+'대댓 작성일'+'</span></div></li></ul>';
                        
                        replyList += '<div class="CommentForm_Wrapper"><div class="CommentForm"><textarea class="CommentForm_Textarea" name="commentContent" title="댓글 입력" placeholder="이 곳에 댓글을 남겨주세요." style="height: 30px;"></textarea><button class="RUIButton RUIButton-color-blue RUIButton-size-small CommentForm_SubmitButton" disabled="">댓글 달기</button></div></div></div></div></li>';
				...
				success:function(data){
                        ...
                        console.log("성공");
                            ...
                            $.each(data, function(index, item){
                                ...
                                reply += '<li class="ReviewItem"><div class="ReviewItem_Left"><span class="StarRating_IconBox" style="width: 60px; height: 12px;"><span class="StarRating_Icon_Background" style="width: 60px; height: 12px;"></span><span class="StarRating_Icon_Foreground_Mask" style="width: '+item.reply_star_rate*12+'px; height: 12px;"><span class="StarRating_Icon_Foreground" style="width: 60px; height: 12px;"></span></span></span>';
