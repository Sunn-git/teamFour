...
@WebServlet("/GetBookListByTag.ajax")
public class GetBookListByTagAjax extends HttpServlet {
	private static final long serialVersionUID = 1L;
	
    public GetBookListByTagAjax() {
        super();
    }
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<BookDto> bookList = dao.getBookListByTag(request.getParameter("selectedTag"));
